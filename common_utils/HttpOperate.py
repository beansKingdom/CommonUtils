...
from src.common.result_check import ResultCheck
...
class HttpOperate:
    ...
    def http_get(cls, url, headers, params=None, **kwargs):
        ...
        return ResultCheck.check_http_operate_result(response.text), response.status_code
    ...
    def http_post(cls, url, headers, params=None, cookies=None, data=None,  **kwargs):
        ...
        time.sleep(cls.interval_time)
        return ResultCheck.check_http_operate_result(response.text, operate_type='post'), response.status_code
